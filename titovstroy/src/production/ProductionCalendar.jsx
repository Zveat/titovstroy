// Календарь производства (read-only v1). Перенос из App.jsx.
...
export const _CAL_ST = { todo:{ l:"Не начат", c:"#94a3b8" }, progress:{ l:"В работе", c:"#2563eb" }, done:{ l:"Готово", c:"#059669" }, delayed:{ l:"Задержка", c:"#dc2626" } };
export const _CAL_DAY = 864e5;
export const _calDayStart = (d) => { const x = new Date(d); x.setHours(0,0,0,0); return x.getTime(); };

export function ProductionCalendar({ objects, productions, onOpenObject }) {
